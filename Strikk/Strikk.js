var Strikk = function(el){
    var rootElement = el || console.log("Strikk: Please pass inn a valid deck element into the constructor")
    var self = this
    var deckState
    var uiState
    ...
    //Public functions
    Strikk.prototype.addUI = function (ui){
        this[ui.name] = ui
    }
